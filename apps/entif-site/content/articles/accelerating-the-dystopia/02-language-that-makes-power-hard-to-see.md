...
<h2>Same event. Different field of view.</h2>
...
<div class="language-paper"><span class="memo-label">INTERNAL COMMUNICATION</span><p class="institution-wording">Workforce <em>optimization.</em></p><p class="person-wording">People lose <em>their jobs.</em></p><div class="language-foot"><span class="institution-wording">Attention goes to the organization’s objective.</span><span class="person-wording">Attention goes to the people affected.</span><span aria-hidden="true">↗</span></div></div>
...
The Federal Reserve preserved a useful historical account. In a November 2009 oral-history session, Alan Greenspan recalled a tradition of deliberately maintaining uncertainty about policy to support two-sided markets. He also described that rationale weakening as markets grew. The published transcript notes that he did not review it. The evidence is narrow and useful: a retrospective account of one deliberate communication strategy, and a concrete example of ambiguity serving an institutional purpose. [S103]
...
<h2>Present in the paperwork. Absent from the decision.</h2>
...
<p class="disclosure-conclusion">Four places to look. One decision to make.</p>
...
The administrative-burden literature distinguishes learning costs, compliance costs, and psychological costs. A person has to find out how a process works, do what it requires, and endure the experience of navigating it. Moynihan, Herd, and Harvey developed that framework in research on citizen-state interactions, including a historical Medicaid case. The framework identifies costs that a simple count of completed transactions can miss; the motive behind any particular process is a separate question. [S205]
