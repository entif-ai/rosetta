---
{
  'id': 'entif.essay.etr-2026-07.05',
  'slug': '05-who-creates-the-value-and-who-gets-it',
  'title': 'Who Creates the Value and Who Gets It',
  'description': 'Section 5 of Accelerating the Dystopia: Why Artificial Intelligence Cannot Save a System We Refuse to Fix. Who Creates the Value and Who Gets It.',
  'kind': 'essay',
  'status': 'published',
  ...
  'sourceRefs':
    [
      'https://drive.google.com/file/d/1eyQLUSGIIqbk7_-HrLEA-0NHxVBps5CY/view?usp=drivesdk',
    ],
  'series': { 'id': 'accelerating-the-dystopia', 'order': 5 },
}
---
...
The fact that shareholders legally own the corporation tells me how the current institution distributes claims. It does not deduce from first principles that this distribution is just.

Imagine an apple cart.
...
That question becomes urgent as automation increases.

Acemoglu and Restrepo's task framework is helpful because it strips away the mythology. Production consists of tasks. Some tasks can be performed by labor, some by capital, some by both. When technology moves a task from labor to capital, a displacement effect occurs. When technology creates new tasks in which people have an advantage, a reinstatement effect occurs. [S114]

Automation is therefore not automatically anti-worker. The outcome depends on which effect dominates and on the institutions surrounding the transition.
...
The distributional baseline is measurable. In Q2 2026 labor's share of nonfarm business-sector output hit 52.8%, the lowest in the BLS series beginning in 1947. [S117] The Federal Reserve's Q1 2026 distributional accounts imply the top tenth of households owns roughly 68% of household net worth while the bottom half owns roughly 2.5%. [S118]

That ownership distribution matters because many AI capabilities depend on assets and contractual access controlled by their owners. A purchased AI service may be an operating expense to its customer; that does not erase the ownership of the infrastructure supplying it.
...
The interesting question is institutional:

**Who owns the machines, who owns the firms, who has bargaining power, who receives the productivity dividend, and who bears transition costs?**
...
The worker can work thirty hours for forty hours of pay.

The worker can produce more in forty hours and receive some of the gain.

The employer can raise output expectations until forty hours feels exactly as pressured as before.

The employer can eliminate part of the team and distribute the same workload among fewer people using AI.

The employer can retain everyone, lower prices, gain market share, and grow.
...
The AI transition will answer that question in practice.

If millions of workers become dramatically more productive and the outcome is shorter workweeks, higher wages, stronger public services, cheaper essentials, new forms of ownership, and broad household wealth creation, AI could reduce many of the pathologies described in this essay.

If the outcome is thinner headcount, more intense surveillance, individualized productivity targets, greater capital concentration, weaker bargaining, and a growing population renting access to intelligence owned by a handful of firms, then the technology will have solved the wrong problem beautifully.
...
Imagine a small design business with ten employees. A new tool reduces the time required to prepare a routine draft. In one scenario, the firm wins more clients, hires another person, and shares the gain through pay. In another, it keeps revenue steady and reduces working hours. In a third, it cuts staff and uses the remaining team to maintain output. In a fourth, competitors adopt the same tool, prices fall, and most of the gain reaches clients rather than employees or owners.
...
AI can interact with both accounts. It can raise a worker's income by making their skills more productive. It can also raise the expected returns to a firm that owns a useful model, a distribution channel, or complementary infrastructure. If access to those returns is uneven, income gains and wealth concentration can move in different directions.

The IMF's distributional model is useful for making that possibility explicit. Its scenarios distinguish labor displacement, complementarity, and capital returns. A reduction in wage inequality in a scenario does not imply a reduction in wealth inequality. [S179] That is not a prediction that a particular distribution must occur. It is a warning against using one measure as a substitute for another.

The current Census result belongs here rather than in a footnote reluctantly added to protect an argument. Real median household money income rose in 2025. That is a positive change in the measure. It does not tell us that every household improved, and it does not measure the distribution of net worth. The release also reports that the change in the income Gini was not statistically significant. Those findings can coexist without contradiction. [S119]

An argument about stratification should be able to survive good news because stratification is not defined as the absence of every improvement. It concerns differences in resources, security, access, and the capacity to benefit from future change. A rising median can be part of a better trajectory. It is not a complete description of that trajectory.

## The value of work is larger than the record of tasks

Task-based analysis is more useful than treating each occupation as one indivisible object. A job can contain drafting, judgment, relationship management, checking, coordination, and responsibility for unusual cases. A tool may automate one component and increase the importance of another. [S114][S180]
...
A long-run gain can coexist with a severe short-run loss. That is not a paradox. A new industry may emerge after a person has exhausted savings. A lower price may arrive after a household has lost its income. A training opportunity may be useful but incompatible with the time and money available during the transition.
...
There is no single distributional arrangement implied by intelligence. A more capable system can support higher output, better quality, lower prices, shorter hours, greater profits, or some combination. It can also change which participants have leverage over the combination.
