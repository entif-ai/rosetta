...
A feed is a selection of events, not a census of ordinary life. A person may encounter many unusual incidents because each is individually compelling. The selection can be accurate at the level of the incidents and misleading as an impression of prevalence.

Consider an illustrative stream containing a sequence of rare failures. Each report is real. The stream leaves out the much larger number of uneventful interactions. A reader may come away believing that failure is typical. The problem is not necessarily fabrication. It is the missing denominator.
